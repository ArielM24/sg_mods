...
public class SwapKeyBinding extends KeyBinding {
    ...
    public SwapKeyBinding(String translationKey, int defaultkey, String category) {
        super(
                ...
                KeyBinding.Category.create(Identifier.of("sg","mods")) // The translation key of the keybinding's category.
        );
    ...
    public void onPressBypass() {
        ...
        try {
            ...
            System.out.println("SG Elytra creative inventory swapping is not compatible with this version of Minecraft");
        }
